        ...
        <CardContent className="px-8 pb-8">
          {emailSent && !isResetMode ? (
            ...
            <form onSubmit={handleUpdatePassword} className="space-y-5">
                ...
                <div className="relative">
                  <Input
                    ...
                    className={`h-12 pl-4 pr-12 border-2 transition-all duration-200 rounded-lg ${
                      passwordError ? 'border-destructive' : 'border-gray-200 focus:border-blue-500'
                    }`}
                    placeholder="••••••••"
                    required
                  />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`h-12 pl-4 pr-4 border-2 transition-all duration-200 rounded-lg ${
                    confirmPasswordError ? 'border-destructive' : 'border-gray-200 focus:border-blue-500'
                  }`}
                  placeholder="••••••••"
                  required
                />
              ...
              <Button
                type="submit"
                className="w-full h-12 bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-700 hover:to-emerald-700 text-white font-semibold transition-all duration-300 rounded-lg"
                disabled={isLoading}
              >
                {isLoading ? (
            ...
            <form onSubmit={handleRequestReset} className="space-y-5">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`h-12 pl-4 pr-4 border-2 transition-all duration-200 rounded-lg ${
                    emailError ? 'border-destructive' : 'border-gray-200 focus:border-blue-500'
                  }`}
              ...
              <Link 
                to="/" 
                className="flex items-center justify-center gap-2 text-sm text-gray-600 hover:text-blue-600 transition-colors mt-4"
              >
                <ArrowLeft className="w-4 h-4" />
                Back to Login
              </Link>
