...
const Login = () => {
  ...
  return <div className="gradient-hero relative min-h-screen overflow-hidden flex items-center justify-center p-4 sm:p-8">
      ...
      <Card className="relative z-10 w-full max-w-md overflow-hidden border-primary-foreground/20 bg-card/95 shadow-elevated backdrop-blur animate-fade-in">
        ...
        <CardContent className="px-6 pb-8 sm:px-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button type="submit" className="gradient-success w-full h-11 group border-0 text-primary-foreground hover:opacity-90" disabled={isLoading}>
