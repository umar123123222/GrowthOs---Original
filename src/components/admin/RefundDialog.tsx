    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke('process-refund', {
        body: {
          ...
          suspend_lms: true,
          proof_attachments: proofPayloads.length ? proofPayloads : undefined,
          proof_attachment: proofPayloads[0], // backward compatibility
        },
      });
      ...
      <DialogContent className="max-w-lg">
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            <div>
              <Label htmlFor="refund-proof">Proof of Refund <span className="text-muted-foreground text-xs">(optional, max 8 MB each — attach one or more files to the email)</span></Label>
              {proofFiles.length > 0 && (
