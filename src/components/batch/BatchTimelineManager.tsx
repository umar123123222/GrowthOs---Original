...
import { 
  Plus, Edit, Trash2, Video, Radio, Calendar, Clock, 
  Link as LinkIcon, Lock, Unlock, Play, Eye, GripVertical,
  ArrowLeft, FileText
} from 'lucide-react';
        ...
        <CardContent>
          {timelineItems.length === 0 ? (
            <div className="text-center py-12 text-muted-foreground">
              ...
              <p>Add recordings and live sessions to build your batch timeline</p>
            </div>
          ) : (
              ...
              {timelineItems.map((item, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant={item.type === 'RECORDING' ? 'default' : 'secondary'}>
                      {item.type === 'RECORDING' ? 'Recording' : 'Live Session'}
                    </Badge>
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      {item.type === 'LIVE_SESSION' && item.start_datetime && (
                        <> • Session: {format(new Date(item.start_datetime), 'MMM dd, h:mm a')}</>
                      )}
                      {item.assignment && (
