-- Clean up existing assignment/submission related tables and functions
DROP TRIGGER IF EXISTS handle_assignment_submission_events_trigger ON assignment_submissions;
DROP TRIGGER IF EXISTS handle_assignment_evaluation_trigger ON assignment_submissions;
DROP TRIGGER IF EXISTS notify_assignment_deletion_trigger ON assignment;

DROP FUNCTION IF EXISTS handle_assignment_submission_events();
DROP FUNCTION IF EXISTS handle_assignment_evaluation();
DROP FUNCTION IF EXISTS notify_assignment_deletion();
DROP FUNCTION IF EXISTS review_assignment_submission(uuid, text, integer, text, text);
DROP FUNCTION IF EXISTS fn_approve_submission(uuid, text, text);
DROP FUNCTION IF EXISTS approve_assignment_submission(uuid, uuid, text);
DROP FUNCTION IF EXISTS is_assignment_passed(uuid, uuid);
