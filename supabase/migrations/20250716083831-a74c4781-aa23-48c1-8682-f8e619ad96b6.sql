...
UPDATE users 
SET email = 'temp_' || email 
WHERE id = '4af89070-ca6f-4d94-86a4-6ea9f8e714f8';

-- Step 2: Create new user record with correct auth ID
INSERT INTO users (
...
SELECT 
  ...
  full_name, role, phone, status, created_at,
  onboarding_done, lms_user_id, lms_password, meta_ads_credentials,
  shopify_credentials
FROM users 
WHERE email = 'temp_umaridmpakistan@gmail.com' AND id = '4af89070-ca6f-4d94-86a4-6ea9f8e714f8';

-- Step 3: Update foreign key references to point to the new user ID
