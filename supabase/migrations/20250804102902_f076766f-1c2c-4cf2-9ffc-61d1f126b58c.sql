-- Add missing lms_password column to users table
-- This column is referenced in triggers but doesn't exist, causing 500 errors

ALTER TABLE public.users ADD COLUMN IF NOT EXISTS lms_password text;

-- Update the create_student_atomic function to include the lms_password field
...
BEGIN
  ...
  INSERT INTO public.users (
    ...
    p_phone,
    'student',
    p_installments::text || '_installments',
    v_student_id,
    'Active',
    'inactive',
    v_temp_password,
  ...
  v_result := json_build_object(
    ...
    'email', p_email,
    'phone', p_phone,
    'fees_structure', p_installments::text || '_installments',
    'status', 'Active',
    'lms_status', 'inactive',
