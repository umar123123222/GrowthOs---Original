-- Fix the ID mismatch issue in create_student_atomic function
...
BEGIN
  ...
  -- Insert user record using the provided user_id from auth.users
  INSERT INTO public.users (
    ...
    p_user_id, -- Use the provided user_id instead of generating new one
    p_email,
    p_full_name,
    p_phone,
    'student',
  ...
  SELECT 
    p_user_id, -- Use the provided user_id
  ...
  v_result := json_build_object(
    'success', true,
    'user_id', p_user_id, -- Use the provided user_id
    'student_id', v_student_id,
    'full_name', p_full_name,
    'email', p_email,
    'phone', p_phone,
