...
BEGIN
  ...
  -- Any active enrollment that grants access to this course counts (direct, pathway, or batch).
  ...
  WITH ordered_lessons AS (
    SELECT al.id, al.recording_title, al.sequence_order, al.drip_days, al.assignment_id, m."order" as module_order,
