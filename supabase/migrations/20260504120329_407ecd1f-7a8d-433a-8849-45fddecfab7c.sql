...
BEGIN
  ...
  SELECT
    ...
    (
      -- Drip lock has highest priority: if drip date hasn't arrived, lesson is locked
      -- regardless of prior watch or manual unlock. Manual admin unlock still bypasses.
      CASE
